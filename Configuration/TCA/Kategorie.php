...
$GLOBALS['TCA']['tx_pmfaq_domain_model_kategorie'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_pmfaq_domain_model_kategorie']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_pmfaq_domain_model_kategorie.pid=###CURRENT_PID### AND tx_pmfaq_domain_model_kategorie.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:pmfaq/Resources/Private/Language/locallang_db.xlf:tx_pmfaq_domain_model_kategorie.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
