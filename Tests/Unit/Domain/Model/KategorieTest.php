...
/**
 * Test case for class \Parrotmedia\Pmfaq\Domain\Model\Kategorie.
 *
...
class KategorieTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Parrotmedia\Pmfaq\Domain\Model\Kategorie
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Parrotmedia\Pmfaq\Domain\Model\Kategorie();
	}
